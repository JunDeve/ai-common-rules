...
Read the project's domain glossary (CONTEXT.md) and any ADRs in docs/adr/ first. If these files don't exist yet, create them lazily as decisions crystallize.
...
Use CONTEXT.md vocabulary for the domain. If a candidate contradicts an existing ADR, mark it clearly and only surface it when friction is real enough to warrant revisiting.
